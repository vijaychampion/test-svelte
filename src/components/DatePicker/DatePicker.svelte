<script>
  ...
  function selectDate(date) {
    if (date === "Today") {
      ...
      const nearestMinute = String(roundedMinutes).padStart(2, "0");

      // Adjust hour and AM/PM based on rounding
      ...
      selectedHour.set(String(hours).padStart(2, "0"));
      selectedMinute.set(nearestMinute);
...
<div class="relative max-w-md mx-auto" bind:this={datePickerRef}>
  <button
          ...
          <div class="gap-1 flex justify-between items-end mt-4">
            ...
            <Button
              ...
              on:click={() => {
                selectedDate.set("");
                selectedHour.set("01");
                selectedMinute.set("00");
                selectedMeridiem.set("AM");
              }}
            >
              Clear
            </Button>
