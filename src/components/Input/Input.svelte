    ...
    {:else}
      <div class="flex items-center">
        <input
          ...
          {maxlength}
          {minlength}
          class="py-3 px-4 text-Text-Tartiary font-medium text-sm leading-3 border rounded-md focus:outline-none focus:ring-2 focus:border-blue-500 hover:border-blue-500 {icon
            ? 'pr-10'
