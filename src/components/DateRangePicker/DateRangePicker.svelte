...
<div class="relative max-w-4xl mx-auto max-sm:mx-2" bind:this={pickerRef}>
  <button
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="h-full w-full flex flex-1 flex-col">
          ...
          <div class="gap-1 flex justify-between items-end mt-auto w-full">
            <Button strokebtn size="full" on:click={handleCancel}>Cancel</Button
            >
            <Button size="full" on:click={handleApply}>Apply</Button>
          </div>
        </div>
      </div>
    </div>
